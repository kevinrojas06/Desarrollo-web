  ...
  <body class="text-center" style="background-color:#036bfc;">
    ...
    <form action="ingresardatosproyectobd.php" method="post">
      ...
      <h2 align="center">REGISTRATE</h2>
        ...
        <button class="btn btn-lg btn-block btn-success" type="button" onclick="window.location.href='http://localhost/bootstrap/Proyecto/datos.php'" name="button">
          <font style="vertical-align:inherit;">Ver tabla de datos</font>
        </button>
