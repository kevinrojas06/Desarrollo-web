  ...
  <body style="background-color:#036bfc;">
    ...
    if (isset($_POST['registrar']) && $_POST['email']) {
     ...
     ?>
      ...
      <div class="container">
        <button style="margin-top:-60px;" class="btn btn-success btn-lg btn-block" type="button" onclick="window.location.href='http://localhost/bootstrap/Proyecto/datos.php'" name="button"><font style="vertical-align:inherit;">Ir a la tabla de datos</font></button>
      </div>
