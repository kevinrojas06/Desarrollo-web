...
<html lang="es" dir="ltr">
  <head>
    <link rel="stylesheet" href="css/cinepolis.css">
    <meta charset="utf-8">
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
    <title>Descuentos cinepolis</title>
  </head>
  ...
  <body>
    ...
    <div class="contenido">
      <div class="contenedor">
         <ul>
           <li><h3>DESCUENTOS cinepolis</h3></li>
           <img src="img/cinepolis.png" alt="">
        ...
        <div class="descuentos">
          <ul>
            <li class="desc">
            <h2>TITULO CUPON DESCUENTOS</h2>
            <p>Descripcion breve de su uso</p>
            <p>Dia de publicacion del descuento</p>
            <p>Duracion-caducidad (DD/MM/AAAA)</p>
            </li>
            <li class="desc">
            <h2>TITULO CUPON DESCUENTOS</h2>
            <p>Descripcion breve de su uso</p>
